...
lag_data$tribe <- factor(lag_data$tribe, ordered = T,
                         levels = c("Limnodynastidae", "Myobatrachidae", "Pelodryadidae",
                                    "Asterophryninae", "Bufonidae", "Ranidae"))
...
highlights frog tribes and the five most prolific recorders in color (IDs: 35320, 5742, 35717, 12664, 41581),
...
test_1.1 <-
  ...
  geom_text(aes(x = as_datetime("2023-02-01 00:00:01"), y = 650, label = tribe),
