...
final_plot <- suffrage_plot/female_pres_plot + plot_annotation(title = "Having suffrage vs having women president", subtitle = str_wrap("Among presidential political systems suffrage has become widespread in the second half of 20th Century but the number of women presidents remains very low. the first female president in the dataset is Isabel Peron elected in Argentina in 1975.", width = 100), caption = "#Tidytuesday 2023 Week 8 | data from {democracyData} R package | @michal_wypych", theme = theme_45())
